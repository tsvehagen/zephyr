...
#ifndef ZEPHYR_INCLUDE_DRIVERS_MODEM_MODEM_IFACE_SPI_H_
#define ZEPHYR_INCLUDE_DRIVERS_MODEM_MODEM_IFACE_SPI_H_
...
struct modem_iface_spi_data {
	...
	/* gpio device for handshake pin */
	struct device *handshake_gpio_dev;
	struct gpio_callback handshake_gpio_cb;
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_MODEM_MODEM_IFACE_SPI_H_ */
